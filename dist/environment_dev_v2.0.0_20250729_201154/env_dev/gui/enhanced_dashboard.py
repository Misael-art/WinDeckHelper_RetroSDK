...
class EnhancedDashboard(tk.Tk):
    ...
    def setup_header(self, parent):
        ...
        # Show logs button
        self.logs_button = ttk.Button(actions_frame,
                                    text="📋 View Logs",
                                    command=self.show_logs)
        self.logs_button.pack(side=tk.RIGHT, padx=(10, 0))
    ...
    def setup_components_section(self, parent):
        ...
        # Quick component list (simplified view)
    ...
    def install_selected_component(self):
        ...
        if selection:
            ...
            # Extract component name from display text
            component_name = item_text.split('] ')[1].split(' - ')[0]
            self.notification_center.installation_started(component_name)
