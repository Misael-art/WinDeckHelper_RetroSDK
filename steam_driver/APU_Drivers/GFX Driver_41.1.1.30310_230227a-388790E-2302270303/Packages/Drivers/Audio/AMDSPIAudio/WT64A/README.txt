...
Description
-------------------------
This driver supports the AMD SPI Controller.
...
4. There should be a device in the section named "Other Devices" with name "Unknown Device", with Hardware Id as *ACPI\AMDI0062*.
...
2. Select "Classic View" from the left pane.
3. Invoke Device Manager. 
4. There should be a device section named "AMD SPI Controller"
5. Right-click on "AMD SPI Controller", and click on "Update Driver".
6. Select "Browse my computer for driver software".
7. Click "Browse" to choose the installation files and click "OK".
8. A box will appear: "The wizard has finished installing the software", click "Finish" to complete the installation.
...
3. Invoke Device Manager. 
4. There should be a device section named "AMD SPI Controller".
5. Right-click on the “AMD SPI Controller”, and click on "Uninstall".
