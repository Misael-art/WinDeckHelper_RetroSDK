...
from env_dev.utils.error_handler import file_error, handle_exception, ErrorSeverity, ErrorCategory

# Importa o sistema de log
from env_dev.utils.log_manager import setup_logging, ROLLBACK
